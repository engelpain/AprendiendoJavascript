...
Cadenas de caracteres
  Son variables con un valor alfanumérico. Para denotar una variable con tipo cadena basta con envolver el valor entre
  comillas simples.

Nota: No existe diferencia entre usar comillas simples o dobles, sin embargo las buenas prácticas de programación
declaran que se deben utilizan comillas simples cuando se están declarando cadenas.
--------------------------------------------------------------------------------------------------------------------- */
...
* Concatenar: 'texto plano '+ variable
  - Descripción: Unión entre texto y cualquier otra cosa, variables, más texto, etc.
--------------------------------------------------------------------------------------------------------------------- */
var cadena = 'Hola Mundo';
